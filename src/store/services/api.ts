...
export const api = createApi({
 ...
 export const { useGetDishesByRestaurantIdQuery, useGetReviewsByRestaurantIdQuery, useGetRestaurantsQuery,useCreateReviewMutation,useUpdateReviewMutation} = api